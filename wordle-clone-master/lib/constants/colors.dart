...
const correctGreen = Color.fromARGB(255, 107, 170,
    100); //green - letter is part of the word and in correct position
const containsYellow = Color.fromARGB(255, 201, 180,
    87); //yellow - letter is part of the word but not in correct position
